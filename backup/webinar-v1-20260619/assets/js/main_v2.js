...
const lang = {
  ru: {
    ...
    "welcome-desc": "Лекция и практика от Александра Андрияшкина и Владимира Варнавы — «Современный танец и перформанс в эпоху рилс. Инсайты от Александра Андрияшкина и Владимира Варнавы»",
    ...
    "badge-webinar": "sreda+seamless",
      "webinar-title": "Современный танец и перформанс<br>в эпоху Reels",
  ...
  en: {
    ...
    "welcome-desc": "Lecture and practice from Alexander Andriyashkin and Vladimir Varnava — \"Contemporary Dance and Performance in the Age of Reels. Insights from Alexander Andriyashkin and Vladimir Varnava\"",
    ...
    "problem-text": "We live in a time when performance is no longer limited to the stage. Today, movement, images and personal stories exist across different spaces — from theatre and galleries to digital platforms. Reels, videos and social media have become part of the language of our time. But behind every image there is a deeper question: • How does an idea become a form? • How does a feeling become a movement? • How does an internal impulse become something that can be shared with others?",
    ...
    "session-ru-label": "🇷🇺 Russian session",
    "session-en-label": "🇬🇧 English session",
    "session-ru-date-label": "July 7, Tuesday",
    "session-en-date-label": "July 15, Wednesday",
    "faq-q1": "Do I need dance experience?",
    "faq-a1": "Any level. The intensive is designed for both beginners and practicing dancers, performers, and movement researchers.",
